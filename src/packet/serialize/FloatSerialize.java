 ...
 * @author Ilya Sokolov
 */
public class FloatSerialize extends BaseSerialize {
	public static final Class<?>[] classes = new Class<?>[] { float.class, Float.class };
	...
	public <T, ReadObjectType> T read(ReadObjectType in, Registry reg, Reader<ReadObjectType> reader)
		...
		return (T)(Float)reader.readFloat(in);
	}
	/* (non-Javadoc)
