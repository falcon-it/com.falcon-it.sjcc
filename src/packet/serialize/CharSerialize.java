 ...
 * @author Ilya Sokolov
 */
public class CharSerialize extends BaseSerialize {
	public static final Class<?>[] classes = new Class<?>[] { char.class, Character.class };
	...
	public <T, ReadObjectType> T read(ReadObjectType in, Registry reg, Reader<ReadObjectType> reader)
		...
		return (T)(Character)reader.readChar(in);
	}
	/* (non-Javadoc)
	...
	public <T, WriteObjectType> void write(WriteObjectType out, T v, Registry reg, Writer<WriteObjectType> writer)
			throws PacketIOException {
		writer.writeChar(out,(Character)v);
	}
}
